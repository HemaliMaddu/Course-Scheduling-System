...
public class LectureSlotsAvailable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LectureSlotsAvailable frame = new LectureSlotsAvailable();
	...
	public LectureSlotsAvailable() {
		...
		nextBtn.addActionListener(new ActionListener() {
			...
			{
				LectureSlotsAvailable ls = new LectureSlotsAvailable();
				ls.setVisible(true);
			}
		});
